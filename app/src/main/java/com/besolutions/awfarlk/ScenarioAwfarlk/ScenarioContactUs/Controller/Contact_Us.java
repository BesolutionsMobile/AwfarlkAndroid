package com.besolutions.awfarlk.ScenarioAwfarlk.ScenarioContactUs.Controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagecart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Contact_Us.this, Cart.class));

            }
        });
        txtpagenametoolbar = findViewById(R.id.txtPageNameToolbar);
        txtpagenametoolbar.setText("Contact Us");
