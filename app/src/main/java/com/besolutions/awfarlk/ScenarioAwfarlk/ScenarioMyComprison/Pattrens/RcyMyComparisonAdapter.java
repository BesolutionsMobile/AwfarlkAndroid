...
public class RcyMyComparisonAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{

    TinyDB tinyDB;
    List<model_MyComparison> mMainGridList;
    Context mContext;


    public RcyMyComparisonAdapter(List<model_MyComparison> songsList, Context context) {
    ...
    {
        View ads = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_comparison,parent,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        final model_MyComparison catrgory  = mMainGridList.get(position);
